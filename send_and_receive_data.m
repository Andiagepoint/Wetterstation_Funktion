function [ value ] = send_and_receive_data( modbus_msg, field_name, resolution, con_qual , daychange )
...
[value, error_msg] = rxdata_processing( rxdata, modbus_msg, field_name, resolution, con_qual, daychange );
